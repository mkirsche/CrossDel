...
echo 'aligned reads'
delete=`java -cp "${BINDIR}" BestInsertFinder2 $OUTDIR/results/"$x"_all.sam.$c $x $offset 'SEQ'`
pos=`java -cp "${BINDIR}" BestInsertFinder2 $OUTDIR/results/"$x"_all.sam.$c $x $offset 'POS'`
